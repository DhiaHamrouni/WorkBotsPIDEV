...
public class Agence {
    ...
    public Agence(String numTel_agence, String email_agence, String siteWeb_agence) {
    ...
    public Agence(int id_agence, String numTel_agence, String email_agence, String siteWeb_agence) {
