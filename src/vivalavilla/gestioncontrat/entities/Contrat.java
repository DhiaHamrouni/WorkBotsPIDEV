...
public class Contrat {
    ...
    public Contrat(int id_bien_contrat, String nom_bien_contrat, String nom_client_contrat, String nom_vendeur_contrat, String cin_vendeur_contrat, String cin_client_contrat, String agent_contrat) {
    ...
    public String toString() {
        return "Contrat{" + "id_bien_contrat=" + id_bien_contrat + ", nom_bien_contrat=" + nom_bien_contrat + ", nom_client_contrat=" + nom_client_contrat + ", nom_vendeur_contrat=" + nom_vendeur_contrat + ", cin_vendeur_contrat=" + cin_vendeur_contrat + ", cin_client_contrat=" + cin_client_contrat + ", agent_contrat=" + agent_contrat + '}';
    }
}
